...
def generate_random_cases(num_files=20):
    ...
    for filename, lines in hardcoded.items():
      input_f_path = os.path.join("./data/sample/", filename)
      ...
      with open(input_f_path, "r") as input_file:
        ...
        output_f_path = os.path.join("./data/sample/", output_f_name)
    ...
    greedy_path = os.path.join("./data/secret/", "secret_greedy_large.in")
    with open(greedy_path, "w") as f:
      f.write("\n".join(greedy_lines) + "\n")
    
    with open(greedy_path, "r") as input_file:
      greedy_output_path = os.path.join("./data/secret/", "secret_greedy_large.ans")
      input_lines = input_file.readlines()
      res = solve_for_output(input_lines)
    ...
    inorder_path = os.path.join("./data/secret/", "secret_inorder_large.in")
    with open(inorder_path, "w") as f:
      f.write("\n".join(inorder_lines) + "\n")
    
    with open(inorder_path, "r") as input_file:
      inorder_output_path = os.path.join("./data/secret/", "secret_inorder_large.ans")
      input_lines = input_file.readlines()
      res = solve_for_output(input_lines)
    ...
    mixed_path = os.path.join("./data/secret/", "secret_mixed_large.in")
    with open(mixed_path, "w") as f:
      f.write("\n".join(mixed_lines) + "\n")
    
    with open(mixed_path, "r") as input_file:
      mixed_output_path = os.path.join("./data/secret/", "secret_mixed_large.ans")
      input_lines = input_file.readlines()
      res = solve_for_output(input_lines)
    ...
    for i in range(1, num_files + 1):
      ...
      input_f_path = os.path.join("./data/secret/", input_f_name)
      ...
      with open(input_f_path, "r") as input:
        ...
        output_f_path = os.path.join("./data/secret/", output_f_name)        
