...
Each \(trap_i\) requires s steps and has c complexity. After each step of disarming a trap, Jimothy incurs fatigue based on the complexity of the trap he has solved with the most steps (none if it is the first).\\\\
