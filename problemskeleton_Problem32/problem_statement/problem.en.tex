...
Each \(trap_i\) requires s steps and has c complexity. For each step of disarming a trap, Jimothy incurs fatigue equal to the complexity of the trap he has solved with the most steps (none if it is the first).\\\\
